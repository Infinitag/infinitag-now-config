...
4-Tasten-Board (I²C), KY-040-Encoder, 4×AA über Schiebeschalter +
1N5817 an 5V-Pin, Batteriemessung über 100k/47k-Teiler an GPIO3.
Keine Status-LED – alles Feedback läuft über das OLED (GPIO-Plan v3,
2026-07-09). Pinbelegung: `src/Config.h`.
...
| `src/UiController.*` | Menü-State-Machine + OLED-Rendering (inkl. Batterieanzeige im Tools-Menü) |
